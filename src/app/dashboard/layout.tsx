  ...
  return (
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900 dark:border-slate-700">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map(link => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:bg-slate-900 dark:border-slate-700 dark:hover:bg-slate-800 dark:text-slate-300"
                      >
        ...
        <div id="main-content" className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64 dark:bg-slate-800">
          <main>
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 dark:bg-slate-900 dark:border-slate-700">
